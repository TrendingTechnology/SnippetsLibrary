...
struct SnippetDetailsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: .zero) {
            ...
            .foregroundColor(.primary.opacity(Layout.mediumOpacity))
            ...
            GeometryReader { geometry in
                SourceCodeTextEditor(
                    ...
                    shouldBecomeFirstResponder: viewModel.type == .create
                )
                .frame(
            ...
            HStack {
                ...
                .disabled(viewModel.type == .create ? !viewModel.canSaveSnippet : !viewModel.hasChanges)
            }
